package com.bank.bian.employeebenefits.model;
...
/**
 * The BIAN control record for this service domain: "Benefit Enrollment Administrative Plan".
 *
 ...
 * to its asset type (Benefit Enrollment). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Benefit Enrollment Administrative Plan";
